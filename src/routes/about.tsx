...
export default function About() {
  return (
    <main class="relative min-h-screen">
      ...
      <div class="relative z-10 mx-auto max-w-3xl 2xl:max-w-4xl px-4 sm:px-6 py-24">
        ...
        <div class="fade-in-up delay-2 mt-8 space-y-6 text-base text-[#8b8b9e] leading-relaxed">
          <p>
