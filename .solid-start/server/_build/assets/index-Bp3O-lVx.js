...
async function GET(event) {
  try {
    ...
    try {
      let result;
      if (q && publishedOnly) {
        result = await db.query("SELECT * FROM dashboard WHERE isPublic = true AND string::lowercase(name) CONTAINS string::lowercase($q) ORDER BY updated_at DESC", {
          q
        });
...
//# sourceMappingURL=index-Bp3O-lVx.js.map
