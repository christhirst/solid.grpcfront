...
function PublicDashboard() {
  ...
  return ssr(_tmpl$19, ssrHydrationKey(), escape(createComponent(Show, {
    ...
    get children() {
      return ssr(_tmpl$18, ssrHydrationKey(), `/dashboards/${escape((dashboard()?.id || params.id || "").replace("dashboard:", ""), true)}`, escape(dashboard().name), escape(createComponent(Show, {
        get when() {
...
//# sourceMappingURL=_id_-Cjq8OYdt.js.map
