...
function CardDescription(props) {
  ...
  return ssrElement("p", mergeProps({
    get ["class"]() {
      return `text-sm text-zinc-400 leading-relaxed ${local.class || ""}`;
    }
  }, rest), () => escape(local.children), true);
}
...
function Input(props) {
  ...
  return ssrElement("input", mergeProps({
    get ["class"]() {
      return `flex h-10 w-full rounded-xl border border-zinc-800 bg-zinc-900/60 px-3.5 py-2 text-base text-white placeholder:text-zinc-500 transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-purple-500/60 focus-visible:border-purple-500/60 disabled:cursor-not-allowed disabled:opacity-50 ${local.class || ""}`;
    }
  }, rest), void 0, true);
}
export {
...
//# sourceMappingURL=input-CptRrWy_.js.map
