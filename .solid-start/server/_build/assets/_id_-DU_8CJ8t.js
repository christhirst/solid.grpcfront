  ...
  return ssr(_tmpl$22, ssrHydrationKey(), ssrAttribute("value", escape(name(), true), false), `px-3 py-1.5 rounded-lg text-xs font-bold text-white transition-all ${hasActiveInput() ? "bg-purple-600 hover:bg-purple-500 shadow-md ring-2 ring-purple-500/50" : "bg-[#2a2a3a] text-[#5b5b6e] cursor-not-allowed"}`, ssrAttribute("title", hasActiveInput() ? "Insert {{ form.variable }} at cursor" : "Select an input field first", false), ssrAttribute("disabled", isNew || isRunning(), true), isRunning() ? _tmpl$23[0] + ssrHydrationKey() + _tmpl$23[1] : _tmpl$24[0] + ssrHydrationKey() + _tmpl$24[1], ssrAttribute("value", escape(serverAddress(), true), false), ssrAttribute("checked", useTls(), true), ssrAttribute("value", escape(schedule(), true), false), `flex-1 py-1.5 text-xs font-bold rounded-md transition-all ${authType() === "grpc" ? "bg-blue-600 text-white shadow-lg" : "text-[#8b8b9e] hover:text-white"}`, `flex-1 py-1.5 text-xs font-bold rounded-md transition-all ${authType() === "rest" ? "bg-blue-600 text-white shadow-lg" : "text-[#8b8b9e] hover:text-white"}`, `flex-1 py-1.5 text-xs font-bold rounded-md transition-all ${authType() === "static" ? "bg-blue-600 text-white shadow-lg" : "text-[#8b8b9e] hover:text-white"}`, escape(createComponent(Show, {
    ...
    get children() {
      return [ssr(_tmpl$8, ssrHydrationKey(), ssrAttribute("value", escape(authService(), true), false), escape(createComponent(For, {
        ...
        children: (svc) => ssr(_tmpl$25, ssrHydrationKey() + ssrAttribute("value", escape(svc.fullName, true), false), escape(svc.fullName))
        ...
        get children() {
          return [ssr(_tmpl$9, ssrHydrationKey(), ssrAttribute("value", escape(authMethod(), true), false), escape(createComponent(For, {
            ...
            children: (m) => ssr(_tmpl$25, ssrHydrationKey() + ssrAttribute("value", escape(m.name, true), false), escape(m.name))
    ...
    get children() {
      return ssr(_tmpl$18, ssrHydrationKey(), escape(createComponent(For, {
        ...
        children: (p) => ssr(_tmpl$25, ssrHydrationKey() + ssrAttribute("value", escape(p.id, true), false), escape(p.name))
      })));
    }
    ...
    get children() {
      return ssr(_tmpl$20, ssrHydrationKey(), `card p-5 border ${runData().status === "completed" ? "border-emerald-500/30" : runData().status === "failed" ? "border-red-500/30" : "border-blue-500/30"}`, `px-2 py-1 rounded text-xs font-bold uppercase tracking-wider ${runData().status === "completed" ? "bg-emerald-500/20 text-emerald-400" : runData().status === "failed" ? "bg-red-500/20 text-red-400" : "bg-blue-500/20 text-blue-400"}`, escape(runData().status), escape(createComponent(For, {
        ...
        children: (log) => ssr(_tmpl$32, ssrHydrationKey(), escape(log.stepId), escape(createComponent(Show, {
          get when() {
            return log.stepType && log.stepType !== "grpc";
          },
          get children() {
            return ssr(_tmpl$28, ssrHydrationKey(), escape(log.stepType));
          }
          ...
          get children() {
            return ssr(_tmpl$29, ssrHydrationKey(), escape(JSON.stringify(log.request, null, 2)), `text-xs font-mono overflow-x-auto bg-[#151520] p-2 rounded ${log.error ? "text-red-300" : "text-emerald-300"}`, escape(log.error) || escape(JSON.stringify(log.response, null, 2)));
          }
        })), escape(createComponent(Show, {
          get when() {
          ...
          get children() {
            return ssr(_tmpl$30, ssrHydrationKey(), escape(createComponent(LogTable, {
              get data() {
                return log.response;
              },
              get columns() {
          ...
          get children() {
            return ssr(_tmpl$31, ssrHydrationKey(), escape(createComponent(LogChart, {
              get data() {
                return log.response;
              },
              get xKey() {
    ...
    each: steps,
    children: (step, index) => ssr(_tmpl$49, ssrHydrationKey(), escape(index()) + 1, ssrAttribute("value", step.type === "chart" ? escape(step.chartType, true) || "bar" : escape(step.type, true) || "grpc", false), ssrAttribute("value", escape(step.id, true), false), escape(createComponent(Show, {
      get when() {
        return !step.type || step.type === "grpc";
      },
      get children() {
        return [ssr(_tmpl$35, ssrHydrationKey(), ssrAttribute("value", escape(step.serviceName, true) || "", false), ssrAttribute("disabled", !step.serviceName, true), escape(createComponent(Show, {
          get when() {
            return savedProtos() && savedProtos().length > 0;
          },
          get children() {
            return ssr(_tmpl$33, ssrHydrationKey(), escape(createComponent(For, {
              get each() {
                return savedProtos();
              },
              children: (p) => ssr(_tmpl$50, ssrHydrationKey(), `PROTO:${escape(p.id, true)}`, escape(p.name))
            })));
          }
        })), escape(createComponent(Show, {
          get when() {
          ...
          get children() {
            return ssr(_tmpl$34, ssrHydrationKey(), escape(createComponent(For, {
              ...
              children: (svc) => ssr(_tmpl$51, ssrHydrationKey() + ssrAttribute("value", escape(svc.fullName, true), false), ssrAttribute("selected", step.serviceName === svc.fullName, true), escape(svc.fullName))
            })));
          }
          ...
          children: (m) => ssr(_tmpl$52, ssrHydrationKey() + ssrAttribute("value", escape(m.name, true), false), ssrAttribute("selected", step.methodName === m.name, true), escape(m.name), escape(m.requestType), escape(m.responseType))
        }))), ssr(_tmpl$38, ssrHydrationKey(), escape(createComponent(Show, {
          get when() {
        ...
        }))), ssr(_tmpl$39, ssrHydrationKey(), ssrAttribute("checked", step.useTls ?? useTls(), true), step.useTls ?? useTls() ? "Secure" : "Insecure"), ssr(_tmpl$40, ssrHydrationKey(), ssrAttribute("value", escape(step.requestBodyTemplate, true), false)), ssr(_tmpl$41, ssrHydrationKey(), ssrAttribute("value", escape(step.headersTemplate, true) || "{}", false))];
      }
    })), escape(createComponent(Show, {
      get when() {
      ...
      get children() {
        return ssr(_tmpl$43, ssrHydrationKey(), ssrAttribute("value", escape(step.restUrl, true) || "", false), ssrAttribute("value", escape(step.restMethod, true) || "GET", false), escape(createComponent(Show, {
          get when() {
            return step.restMethod !== "GET" && step.restMethod !== "DELETE";
          },
          get children() {
            return ssr(_tmpl$42, ssrHydrationKey(), ssrAttribute("value", escape(step.requestBodyTemplate, true) || "", false));
          }
      ...
      get children() {
        return ssr(_tmpl$44, ssrHydrationKey(), ssrAttribute("value", escape(step.databaseName, true) || "", false), ssrAttribute("value", escape(step.requestBodyTemplate, true) || "", false));
      }
    })), escape(createComponent(Show, {
      get when() {
      ...
      get children() {
        return ssr(_tmpl$48, ssrHydrationKey(), ssrAttribute("value", escape(step.requestBodyTemplate, true) || "", false), escape(createComponent(For, {
          get each() {
            return steps.slice(0, index()).filter((s) => !s.type || s.type === "grpc");
          },
          children: (s) => ssr(_tmpl$53, ssrHydrationKey(), `{{ steps.${escape(s.id, true)}.response }}`, escape(s.id), s.methodName ? ` (${escape(s.methodName)})` : "")
        })), ssrAttribute("value", escape(step.dataPath, true) || "", false), escape(createComponent(Show, {
          get when() {
            return step.type === "chart";
          },
          get children() {
            return ssr(_tmpl$46, ssrHydrationKey(), ssrAttribute("value", escape(step.xKey, true) || "", false), ssrAttribute("value", escape(step.yKey, true) || "", false), escape(createComponent(Show, {
              get when() {
                return step.xKey || step.yKey;
              },
              get children() {
                return ssr(_tmpl$45, ssrHydrationKey(), escape(step.xKey) || "index", escape(step.yKey) || "value");
              }
            })));
          }
        })), escape(createComponent(Show, {
          ...
          get children() {
            return ssr(_tmpl$47, ssrHydrationKey(), escape(createComponent(For, {
              get each() {
                return step.columns || [];
              },
              children: (col, ci) => ssr(_tmpl$54, ssrHydrationKey(), ssrAttribute("value", escape(col, true), false))
            })));
          }
        })));
      }
      ...
      get children() {
        return (() => {
          ...
          log?.meta || {};
          return ssr(_tmpl$61, ssrHydrationKey(), `mt-4 pt-4 border-t ${step.type === "table" ? "border-emerald-500/20" : "border-purple-500/20"}`, `text-[10px] font-bold uppercase tracking-wider flex items-center gap-1.5 ${step.type === "table" ? "text-emerald-400" : "text-purple-400"}`, escape(createComponent(Show, {
            get when() {
              return step.type === "table";
            },
            get children() {
              return [ssr(_tmpl$55, ssrHydrationKey()), ssr(_tmpl$56, ssrHydrationKey())];
            }
          })), escape(createComponent(Show, {
            get when() {
              return step.type === "chart";
            ...
            get children() {
              return [ssr(_tmpl$57, ssrHydrationKey()), ssr(_tmpl$58, ssrHydrationKey()), ssr(_tmpl$59, ssrHydrationKey())];
            }
...
//# sourceMappingURL=_id_-DU_8CJ8t.js.map
