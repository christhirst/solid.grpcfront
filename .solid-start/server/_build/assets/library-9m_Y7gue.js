      ...
      return [ssr(_tmpl$9, ssrHydrationKey(), escape(createComponent(Badge, {
        ...
        get children() {
          return ssr(_tmpl$1, ssrHydrationKey(), escape(createComponent(For, {
            ...
            children: (tag) => ssr(_tmpl$12, ssrHydrationKey(), `rounded-lg px-3 py-2 text-xs font-semibold transition-all shrink-0 select-none ${selectedTags().includes(tag) ? "bg-purple-600 text-white shadow-md shadow-purple-500/20" : "bg-zinc-900 text-zinc-400 hover:bg-zinc-800 hover:text-white border border-zinc-800/80"}`, escape(tag))
          })), escape(createComponent(Show, {
            get when() {
...
//# sourceMappingURL=library-9m_Y7gue.js.map
