...
function PublicDashboard() {
  ...
  return ssr(_tmpl$19, ssrHydrationKey(), escape(createComponent(Show, {
    ...
    get children() {
      return ssr(_tmpl$18, ssrHydrationKey(), `/dashboards/${escape(params.id, true)}`, escape(dashboard().name), escape(createComponent(Show, {
        get when() {
...
//# sourceMappingURL=_id_-CPd1yV4i.js.map
