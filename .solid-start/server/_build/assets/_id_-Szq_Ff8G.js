import { createComponent, ssr, ssrHydrationKey, escape, ssrStyle, ssrAttribute } from "solid-js/web";
import { createSignal, onMount, createEffect, Show, For } from "solid-js";
import { D as DefaultChart } from "./index-D4uTJpLk.js";
import { Chart, registerables } from "chart.js";
import * as ChartGeo from "chartjs-chart-geo";
import get from "lodash.get";
import { a as extractRunOutcome, D as DashboardButtonFormWidget, b as applyWidgetConditions, n as newsColorClasses, e as evaluateNewsRules } from "./newsRulesEvaluator-DTKSj8r8.js";
...
import "cookie-es";
function pollRun$1(runId, callbacks, options = {}) {
...
async function triggerWidgetRun(dashboardId, buttonId, form = {}) {
...
function useWidgetOutcome(dashboardId, btn) {
  ...
  onMount(async () => {
    ...
    try {
      ...
      setOutcome({
        data: void 0,
        status: "error",
        error: e.message || "Failed to load widget state"
      });
    }
  });
  return outcome;
}
function DashboardPublicButtonFormWidget(props) {
  const {
    btn,
    dashboardId,
    executing,
            ...
            renderWidget: (btn) => {
              ...
              return createComponent(Show, {
                ...
                get fallback() {
                  ...
                  return createComponent(DashboardPublicButtonFormWidget, {
                    btn,
                    get dashboardId() {
                      return params.id;
                    },
                ...
                get children() {
                  return createComponent(Show, {
                    ...
                    get fallback() {
                      return ssr(_tmpl$21, ssrHydrationKey(), `rounded-2xl border p-5 shadow-xl ${kind() === "table" ? "border-emerald-500/20 bg-[#0a120d]" : "border-purple-500/20 bg-[#100a14]"}`, escape(createComponent(Show, {
                        get when() {
                          return wf();
                        },
                        get fallback() {
...
function InfographicWidget(props) {
  ...
  return ssr(_tmpl$23, ssrHydrationKey(), ssrStyle(`min-height:${props.height || "300px"}`));
}
export {
  PublicDashboard as default,
  id$$
};
//# sourceMappingURL=_id_-Szq_Ff8G.js.map
