...
function AutoWidget(props) {
  ...
  return ssr(_tmpl$10, ssrHydrationKey(), `flex items-center justify-between mb-3 pb-2 border-b ${kind === "table" ? "border-emerald-500/20" : "border-purple-500/20"}`, `text-sm font-bold ${kind === "table" ? "text-emerald-400" : "text-purple-400"}`, kind === "table" ? "📊" : "📈", escape(props.btn.label), escape(createComponent(Show, {
    get when() {
    ...
    get children() {
      return ssr(_tmpl$1, ssrHydrationKey(), escape(errorMsg()));
    }
  })), escape(createComponent(Show, {
    get when() {
      return status() === "ready";
...
function PublicDashboard() {
  ...
  return ssr(_tmpl$15, ssrHydrationKey(), escape(createComponent(Show, {
    ...
    get children() {
      return ssr(_tmpl$14, ssrHydrationKey(), escape(dashboard().name), escape(createComponent(Show, {
        get when() {
                      ...
                      return ssr(_tmpl$36, ssrHydrationKey(), escape(field.label), escape(createComponent(Show, {
                        ...
                        get children() {
                          return ssr(_tmpl$34, ssrHydrationKey(), ssrAttribute("value", escape(val(), true) || "", false), escape(createComponent(For, {
                            ...
                            children: (opt) => ssr(_tmpl$37, ssrHydrationKey() + ssrAttribute("value", escape(opt, true), false), escape(opt))
                          })));
                        }
                      })), escape(createComponent(Show, {
                        get when() {
...
//# sourceMappingURL=_id_-BSIAuzRN.js.map
