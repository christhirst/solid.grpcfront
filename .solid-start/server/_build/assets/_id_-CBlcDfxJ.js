...
function DashboardBuilder() {
  ...
  return ssr(_tmpl$30, ssrHydrationKey(), ssrAttribute("value", escape(name(), true), false), ssrAttribute("value", escape(description(), true), false), escape(createComponent(For, {
    get each() {
      return tags();
    },
    children: (tag) => createComponent(Badge, {
      ...
      get children() {
        return [tag, ssr(_tmpl$31, ssrHydrationKey())];
      }
    })
      ...
      return ssr(_tmpl$27, ssrHydrationKey(), escape(createComponent(Show, {
        ...
        get children() {
          return ssr(_tmpl$23, ssrHydrationKey(), escape([{
            ...
            color: "text-rose-400"
          }].map((opt) => ssr(_tmpl$32, ssrHydrationKey(), `text-lg leading-none mt-0.5 ${escape(opt.color, true)}`, escape(opt.icon), `text-sm font-bold ${escape(opt.color, true)}`, escape(opt.label), escape(opt.desc)))));
        }
      })), escape(createComponent(Show, {
        get when() {
        ...
        children: (btn, index) => {
          ...
          return ssr(_tmpl$45, ssrHydrationKey(), `card p-5 relative border-l-4 group overflow-hidden ${escape(accentCls(), true)}`, escape(createComponent(Show, {
            get when() {
              return varStatus().hasVariables;
            },
            get children() {
              return ssr(_tmpl$33, ssrHydrationKey(), `absolute top-0 left-0 right-0 h-12 rounded-t-2xl pointer-events-none transition-colors border-b ${varStatus().allConfigured ? "bg-emerald-500/20 border-emerald-500/30" : "bg-red-500/20 border-red-500/30"}`);
            }
            ...
            get children() {
              return ssr(_tmpl$34, ssrHydrationKey(), `text-[10px] font-bold px-2 py-0.5 rounded-full border transition-colors ${varStatus().allConfigured ? "bg-emerald-500/20 text-emerald-300 border-emerald-500/40" : "bg-red-500/20 text-red-300 border-red-500/40"}`, varStatus().allConfigured ? "✓ All Vars Configured" : "⚠️ Vars Unconfigured");
            }
            ...
            get children() {
              return ssr(_tmpl$35, ssrHydrationKey(), ssrAttribute("value", escape(btn.color, true), false), escape(createComponent(For, {
                each: colorOptions,
            ...
            get children() {
              return createComponent(For, {
                ...
                children: (w) => ssr(_tmpl$46, ssrHydrationKey() + ssrAttribute("value", escape(w.id, true), false), ssrAttribute("selected", w.id === btn.workflowId, true), escape(w.name))
              });
            }
          })), escape(createComponent(Show, {
            get when() {
            ...
            get children() {
              return ssr(_tmpl$37, ssrHydrationKey(), ssrAttribute("value", escape(btn.columns, true) || "", false));
            }
          })), escape(createComponent(Show, {
            get when() {
              return wt() === "button" || wt() === "form";
            ...
            get children() {
              return ssr(_tmpl$41, ssrHydrationKey(), escape(createComponent(Show, {
                ...
                get children() {
                  return ssr(_tmpl$40, ssrHydrationKey(), escape(createComponent(For, {
                    get each() {
                      return btn.formConfig;
                    },
                    children: (field, fIdx) => ssr(_tmpl$48, ssrHydrationKey(), ssrAttribute("value", escape(field.name, true), false), ssrAttribute("value", escape(field.label, true), false), ssrAttribute("value", escape(field.value, true) ?? escape(field.defaultValue, true) ?? "", false), ssrAttribute("value", escape(field.type, true), false), escape(createComponent(Show, {
                      get when() {
                        return field.type === "select";
                      },
                      get children() {
                        return ssr(_tmpl$47, ssrHydrationKey(), ssrAttribute("value", escape(field.options, true) || "", false));
                      }
                    })))
                  })));
                }
            ...
            get children() {
              return ssr(_tmpl$42, ssrHydrationKey(), ssrAttribute("value", escape(btn.dataPath, true) || "", false), `stream_${escape(btn.id, true)}`, ssrAttribute("checked", btn.streamActive !== false, true), `stream_${escape(btn.id, true)}`, escape(createComponent(For, {
                get each() {
                  return btn.newsRules || [];
                },
                children: (rule, rIdx) => ssr(_tmpl$50, ssrHydrationKey(), ssrAttribute("value", escape(rule.operator, true), false), escape(createComponent(Show, {
                  get when() {
                    return rule.operator !== "default";
                  },
                  get children() {
                    return ssr(_tmpl$49, ssrHydrationKey(), ssrAttribute("value", escape(rule.value, true), false));
                  }
            ...
            get children() {
              return ssr(_tmpl$43, ssrHydrationKey(), ssrAttribute("value", escape(btn.onLabel, true) || "ON", false), ssrAttribute("value", escape(btn.offLabel, true) || "OFF", false), ssrAttribute("value", escape(btn.formVarName, true) || "toggle_state", false), `def_${escape(btn.id, true)}`, ssrAttribute("checked", btn.defaultChecked || false, true), `def_${escape(btn.id, true)}`);
            }
          })), escape(createComponent(Show, {
            get when() {
    ...
    get children() {
      return ssr(_tmpl$29, ssrHydrationKey(), escape(createComponent(Show, {
        ...
        get fallback() {
          return ssr(_tmpl$51, ssrHydrationKey());
        },
        get children() {
          return createComponent(DashboardGrid, {
            buttons,
...
function DashTable(props) {
  ...
  return ssr(_tmpl$53, ssrHydrationKey(), escape(createComponent(Show, {
    ...
    get children() {
      return ssr(_tmpl$52, ssrHydrationKey(), escape(createComponent(For, {
        get each() {
          return effectiveCols();
        },
        children: (col) => ssr(_tmpl$55, ssrHydrationKey(), escape(col))
      })), escape(createComponent(For, {
        get each() {
          return rows();
        },
        children: (row) => ssr(_tmpl$56, ssrHydrationKey(), escape(createComponent(For, {
          get each() {
            return effectiveCols();
          },
          children: (col) => {
            const text = formatCell(cellValue(row, col));
            return ssr(_tmpl$57, ssrHydrationKey(), ssrAttribute("title", escape(text, true), false), escape(text));
          }
        })))
      })));
    }
...
function DashChart(props) {
  ...
  return ssr(_tmpl$59, ssrHydrationKey(), ssrStyle(cType() === "timeline" ? "" : "height:200px"), escape(createComponent(Show, {
    get when() {
...
function PreviewWidget(props) {
  ...
  return ssr(_tmpl$66, ssrHydrationKey(), `text-[10px] font-bold uppercase tracking-wider ${kind === "table" ? "text-emerald-400" : "text-purple-400"}`, kind === "table" ? "📊 Table Preview" : kind === "infographic" ? "🦋 Infographic Preview" : "📈 Chart Preview", escape(props.btn.label), escape(createComponent(Show, {
    get when() {
      return status() === "loading";
    },
    get children() {
      return ssr(_tmpl$62, ssrHydrationKey());
    }
    ...
    get children() {
      return ssr(_tmpl$63, ssrHydrationKey(), props.btn.workflowId ? 'Click "Load Data" to fetch preview' : "Please bind a workflow first");
    }
  })), escape(createComponent(Show, {
    get when() {
      return status() === "loading";
    ...
    get children() {
      return ssr(_tmpl$64, ssrHydrationKey());
    }
  })), escape(createComponent(Show, {
    get when() {
      return status() === "error";
    ...
    get children() {
      return ssr(_tmpl$65, ssrHydrationKey(), escape(error()));
    }
  })), escape(createComponent(Show, {
    get when() {
      return status() === "ready";
...
function NewsWidgetComponent(props) {
  ...
  return ssr(_tmpl$68, ssrHydrationKey(), `w-full rounded-2xl border p-5 shadow-xl transition-all duration-300 ${escape(theme().bg, true)} ${escape(theme().border, true)}`, escape(props.btn.label) || "News Alert", escape(createComponent(Show, {
    get when() {
...
function InfographicWidget(props) {
  ...
  return ssr(_tmpl$70, ssrHydrationKey(), ssrStyle(`min-height:${props.height || "300px"}`));
}
export {
  DashboardBuilder as default,
  id$$
};
//# sourceMappingURL=_id_-CBlcDfxJ.js.map
