...
function Connections() {
  ...
  const [dbTimeoutMs, setDbTimeoutMs] = createSignal(5e3);
        ...
        get children() {
          return ssr(_tmpl$3, ssrHydrationKey(), `grid gap-4 ${isEditing() ? "grid-cols-1" : "grid-cols-1 md:grid-cols-2 lg:grid-cols-3"}`, escape(createComponent(For, {
            ...
            children: (conn) => {
              ...
              return ssr(_tmpl$46, ssrHydrationKey(), `card p-5 cursor-pointer transition-all duration-300 flex flex-col justify-between group ${isSelected() ? "border-blue-500 bg-blue-500/5 shadow-lg shadow-blue-500/10 ring-1 ring-blue-500" : "hover:border-[#3a3a4a] hover:-translate-y-0.5 hover:shadow-xl"}`, escape(createComponent(Show, {
                ...
                when: type === "surrealdb",
                get children() {
                  return [ssr(_tmpl$33, ssrHydrationKey(), escape(conn.url)), ssr(_tmpl$42, ssrHydrationKey(), escape(conn.namespace) || "solidflow", escape(conn.database) || "main", escape(createComponent(Show, {
                    get when() {
                      return conn.timeoutMs;
                    },
                    get children() {
                      return ssr(_tmpl$41, ssrHydrationKey(), escape(conn.timeoutMs));
                    }
                  })))];
                }
              })), escape(createComponent(Show, {
                ...
                get children() {
                  return ssr(_tmpl$44, ssrHydrationKey(), escape(createComponent(Show, {
                    get when() {
                    ...
                    get children() {
                      return ssr(_tmpl$43, ssrHydrationKey(), escape(cardTest().latencyMs));
                    }
                  })));
                }
                ...
                fallback: "Test",
                get children() {
                  return [ssr(_tmpl$45, ssrHydrationKey()), "Testing..."];
                }
              })));
            }
          })));
      ...
      return ssr(_tmpl$23, ssrHydrationKey(), isNew() ? `New ${escape(connType().toUpperCase())} Connection` : `Edit Connection: ${escape(name()) || "Untitled"}`, escape(createComponent(Show, {
        ...
        get children() {
          return ssr(_tmpl$5, ssrHydrationKey(), ssrAttribute("value", escape(url(), true), false), ssrAttribute("value", escape(method(), true), false), ssrAttribute("value", escape(headers(), true), false), ssrAttribute("value", escape(caId(), true), false), escape(createComponent(For, {
            ...
            children: (c) => ssr(_tmpl$49, ssrHydrationKey() + ssrAttribute("value", escape(c.id, true), false), escape(c.name), escape(c.id))
          })));
        }
      })), escape(createComponent(Show, {
        get when() {
        ...
        get children() {
          return ssr(_tmpl$8, ssrHydrationKey(), ssrAttribute("value", escape(serverAddress(), true), false), ssrAttribute("value", escape(protoId(), true), false), escape(createComponent(For, {
            ...
            children: (p) => ssr(_tmpl$49, ssrHydrationKey() + ssrAttribute("value", escape(p.id, true), false), escape(p.name), escape(p.id))
        ...
        get children() {
          return ssr(_tmpl$9, ssrHydrationKey(), ssrAttribute("value", escape(dbUrl(), true), false), ssrAttribute("value", escape(dbNamespace(), true), false), ssrAttribute("value", escape(dbDatabase(), true), false), ssrAttribute("value", escape(dbTimeoutMs(), true), false), ssrAttribute("value", escape(dbUsername(), true), false), ssrAttribute("value", escape(dbPassword(), true), false));
        }
      })), escape(createComponent(Show, {
        get when() {
        ...
        get fallback() {
          return [ssr(_tmpl$52, ssrHydrationKey()), "Test Connection"];
        },
        get children() {
...
//# sourceMappingURL=index-DfSQ6ieq.js.map
