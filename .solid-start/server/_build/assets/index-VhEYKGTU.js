        ...
        children: (d) => createComponent(Card, {
          ...
          get children() {
            return [createComponent(CardHeader, {
              ...
              "class": "px-5 pb-4",
              get children() {
                return ssr(_tmpl$11, ssrHydrationKey(), escape(d.buttons?.length) || 0, d.isPublic ? "Shared" : "Internal");
              }
              ...
              get children() {
                return [ssr(_tmpl$12, ssrHydrationKey()), ssr(_tmpl$14, ssrHydrationKey(), escape(createComponent(Show, {
                  get when() {
                    return d.isPublic;
                  },
                  get children() {
                    return ssr(_tmpl$13, ssrHydrationKey(), `/p/${escape(dashboardId(d.id), true)}`);
                  }
                })))];
              }
            })];
...
//# sourceMappingURL=index-VhEYKGTU.js.map
