...
import "cookie-es";
var _tmpl$ = ["<span", ' class="h-1.5 w-1.5 rounded-full bg-blue-400"></span>'], _tmpl$2 = ["<svg", ' width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M4 19.5A2.5 2.5 0 0 1 6.5 17H20"></path><path d="M6.5 2H20v20H6.5A2.5 2.5 0 0 1 4 19.5v-15A2.5 2.5 0 0 1 6.5 2z"></path></svg>'], _tmpl$3 = ["<svg", ' width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M21 12a9 9 0 0 1-15.5 6.3L3 16"></path><path d="M3 21v-5h5"></path><path d="M3 12a9 9 0 0 1 15.5-6.3L21 8"></path><path d="M21 3v5h-5"></path></svg>'], _tmpl$4 = ["<svg", ' width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><line x1="12" y1="5" x2="12" y2="19"></line><line x1="5" y1="12" x2="19" y2="12"></line></svg>'], _tmpl$5 = ["<div", ' class="flex flex-col gap-6 border-b border-zinc-800/80 p-5 sm:p-6 lg:flex-row lg:items-center lg:justify-between"><div><div class="mb-2">', '</div><h1 class="text-4xl font-extrabold tracking-tight text-white">Dashboards</h1><p class="mt-2 max-w-2xl text-base leading-6 text-zinc-400">Build public or internal boards that turn workflows into buttons, forms, charts, and tables.</p></div><div class="flex flex-col gap-3 sm:flex-row"><a href="/library">', "</a><!--$-->", '<!--/--><a href="/dashboards/new" target="_self">', "</a></div></div>"], _tmpl$6 = ["<div", ' class="grid grid-cols-1 divide-y divide-zinc-800/80 sm:grid-cols-3 sm:divide-x sm:divide-y-0 bg-zinc-950/40"><div class="p-5"><div class="text-sm font-semibold uppercase tracking-wide text-zinc-500">Total</div><div class="mt-2 text-3xl font-bold text-white">', '</div></div><div class="p-5"><div class="text-sm font-semibold uppercase tracking-wide text-zinc-500">Published</div><div class="mt-2 text-3xl font-bold text-emerald-300">', '</div></div><div class="p-5"><div class="text-sm font-semibold uppercase tracking-wide text-zinc-500">Widgets</div><div class="mt-2 text-3xl font-bold text-blue-300">', "</div></div></div>"], _tmpl$7 = ["<div", ' class="col-span-full rounded-xl border border-red-500/20 bg-red-500/10 p-4 text-sm text-red-200">', "</div>"], _tmpl$8 = ["<div", ' class="col-span-full rounded-2xl border border-dashed border-zinc-800 bg-zinc-950/50 px-6 py-16 text-center"><div class="mx-auto mb-4 flex h-12 w-12 items-center justify-center rounded-2xl bg-blue-500/10 text-blue-300 border border-blue-500/20"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="3" width="7" height="7" rx="1"></rect><rect x="14" y="3" width="7" height="7" rx="1"></rect><rect x="14" y="14" width="7" height="7" rx="1"></rect><rect x="3" y="14" width="7" height="7" rx="1"></rect></svg></div><h3 class="mb-2 text-lg font-bold text-white tracking-tight">No dashboards yet</h3><p class="mx-auto mb-6 max-w-md text-sm leading-6 text-zinc-400">Create a dashboard to securely expose your workflows as reusable controls for teammates or external users.</p><a href="/dashboards/new" target="_self">', "</a></div>"], _tmpl$9 = ["<div", ' class="col-span-full rounded-2xl border border-dashed border-zinc-800 bg-zinc-950/50 px-6 py-12 text-center"><h3 class="mb-2 font-bold text-white">No matching dashboards</h3><p class="text-sm text-zinc-400">Try a different search term.</p></div>'], _tmpl$0 = ["<main", ' class="mx-auto max-w-7xl 2xl:max-w-[90rem] px-4 py-8 sm:px-6 lg:py-10"><!--$-->', '<!--/--><div class="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between"><div class="relative w-full sm:max-w-md"><svg class="pointer-events-none absolute left-3.5 top-1/2 -translate-y-1/2 text-zinc-500" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="11" cy="11" r="8"></circle><path d="m21 21-4.3-4.3"></path></svg><!--$-->', '<!--/--></div><div class="text-sm text-zinc-400">', '</div></div><div class="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">', "</div></main>"], _tmpl$1 = ["<div", ' class="col-span-full rounded-2xl border border-zinc-800 bg-zinc-950/60 py-12 text-center text-zinc-400">Loading dashboards...</div>'], _tmpl$10 = ["<div", ' class="flex items-start justify-between gap-4"><div class="min-w-0"><!--$-->', "<!--/--><!--$-->", "<!--/--></div><!--$-->", "<!--/--></div>"], _tmpl$11 = ["<p", ' class="text-sm text-zinc-400 line-clamp-2 mb-3">', "</p>"], _tmpl$12 = ["<div", ' class="flex flex-wrap gap-1.5 mb-3">', "</div>"], _tmpl$13 = ["<div", ' class="grid grid-cols-2 gap-3"><div class="rounded-xl border border-zinc-800/80 bg-zinc-900/50 p-3"><div class="text-xs font-semibold uppercase tracking-wide text-zinc-500">Widgets</div><div class="mt-1 text-xl font-bold text-white">', '</div></div><div class="rounded-xl border border-zinc-800/80 bg-zinc-900/50 p-3"><div class="text-xs font-semibold uppercase tracking-wide text-zinc-500">Access</div><div class="mt-1 truncate text-sm font-semibold text-white">', "</div></div></div>"], _tmpl$14 = ["<span", ' class="text-xs font-medium text-zinc-400 group-hover:text-white transition-colors">Open editor</span>'], _tmpl$15 = ["<a", ' href="', '" target="_blank" class="rounded-lg px-2.5 py-1 text-xs text-blue-400 transition-colors hover:bg-blue-500/10 hover:text-blue-300 flex items-center gap-1 border border-blue-500/20" title="Public View"><span>Public View</span><svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6"></path><polyline points="15 3 21 3 21 9"></polyline><line x1="10" y1="14" x2="21" y2="3"></line></svg></a>'], _tmpl$16 = ["<div", ' class="flex items-center gap-2"><!--$-->', '<!--/--><button class="rounded-lg p-1.5 text-zinc-500 transition-colors hover:bg-red-500/10 hover:text-red-400" title="Delete"><svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M3 6h18"></path><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"></path></svg></button></div>'];
            ...
            return [createComponent(CardHeader, {
              ...
              get children() {
                return ssr(_tmpl$10, ssrHydrationKey(), escape(createComponent(CardTitle, {
                  "class": "truncate text-lg font-bold text-white transition-colors group-hover:text-blue-300",
                  get children() {
...
//# sourceMappingURL=index-CBEymvpq.js.map
