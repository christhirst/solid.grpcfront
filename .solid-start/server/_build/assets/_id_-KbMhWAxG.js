...
import { b as useParams } from "../../entry-server.js";
...
import "cookie-es";
var _tmpl$ = ["<span", ' class="inline-flex items-center gap-1.5 px-2 py-0.5 rounded-full text-[10px] font-bold border bg-purple-500/20 text-purple-300 border-purple-500/30"><span class="w-1.5 h-1.5 rounded-full bg-purple-400 animate-ping"></span>STREAM LIVE</span>'], _tmpl$2 = ["<div", ' class="', '"><div class="flex items-center justify-between mb-3"><div class="flex items-center gap-2"><span class="text-xl">📰</span><h3 class="text-sm font-bold text-white tracking-wide">', '</h3></div><div class="flex items-center gap-2"><!--$-->', '<!--/--><button class="text-[10px] text-slate-400 hover:text-white transition-colors">↻ Refresh</button></div></div><div class="mt-2"><div class="', '">', "</div></div></div>"], _tmpl$3 = ["<div", ' class="w-full rounded-2xl border border-[#2a2a3a] bg-[#12121a] p-4 shadow-xl flex items-center justify-between"><div><h4 class="text-sm font-bold text-white mb-0.5">', '</h4><span class="text-xs text-[#8b8b9e]">State: <strong', ">", "</strong></span></div><button", ' class="', '"><span class="', '"></span></button></div>'], _tmpl$4 = ["<table", ' class="w-full text-left text-xs text-[#c8c8d8]"><thead class="bg-[#1a1a24] text-[#8b8b9e] sticky top-0"><tr>', '</tr></thead><tbody class="divide-y divide-[#1e1e2e]">', "</tbody></table>"], _tmpl$5 = ["<div", ' class="overflow-auto max-h-[400px] rounded-xl border border-[#2a2a3a]/60 bg-[#0a0a0f]">', "</div>"], _tmpl$6 = ["<div", ' class="p-4 text-xs text-[#5a5a6e]">No table data</div>'], _tmpl$7 = ["<th", ' class="px-4 py-2.5 font-semibold border-b border-[#2a2a3e] whitespace-nowrap uppercase text-[10px] tracking-wider">', "</th>"], _tmpl$8 = ["<tr", ">", "</tr>"], _tmpl$9 = ["<td", ' class="px-4 py-2 border-b border-[#1e1e2e]/50 max-w-[200px] truncate"', ">", "</td>"], _tmpl$0 = ["<div", ' class="h-[250px] bg-[#101015] p-3 rounded border border-[#2a2a3a]/50">', "</div>"], _tmpl$1 = ["<p", ' class="text-xs text-[#5a5a6e]">No valid array data for chart</p>'], _tmpl$10 = ["<p", ' class="text-xs text-[#8b8b9e] animate-pulse">Loading map assets...</p>'], _tmpl$11 = ["<svg", ' class="animate-spin h-4 w-4 text-[#8b8b9e]" viewBox="0 0 24 24" fill="none"><circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle><path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path></svg>'], _tmpl$12 = ["<div", ' class="space-y-2"><div class="h-6 rounded bg-[#1e1e2e] animate-pulse"></div><div class="h-6 rounded bg-[#1e1e2e] animate-pulse w-4/5"></div><div class="h-6 rounded bg-[#1e1e2e] animate-pulse w-3/5"></div></div>'], _tmpl$13 = ["<div", ' class="rounded-xl border border-red-500/20 bg-red-500/10 p-4 text-sm text-red-400">✗ <!--$-->', "<!--/--></div>"], _tmpl$14 = ["<div", ' class="w-full"><div class="', '"><h3 class="', '"><!--$-->', "<!--/--> <!--$-->", "<!--/--></h3><!--$-->", "<!--/--></div><!--$-->", "<!--/--><!--$-->", "<!--/--><!--$-->", "<!--/--></div>"], _tmpl$15 = ["<div", ' class="text-center mt-32"><svg width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" class="mx-auto mb-4 text-[#8b8b9e]"><circle cx="12" cy="12" r="10"></circle><line x1="12" y1="8" x2="12" y2="12"></line><line x1="12" y1="16" x2="12.01" y2="16"></line></svg><h1 class="text-2xl font-bold text-white mb-2">Not Found</h1><p class="text-[#8b8b9e]">This dashboard does not exist or is not public.</p></div>'], _tmpl$16 = ["<div", ' class="flex items-center justify-center min-h-screen"><svg class="animate-spin h-8 w-8 text-[#8b8b9e]" viewBox="0 0 24 24" fill="none"><circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle><path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path></svg></div>'], _tmpl$17 = ["<a", ' href="', '" class="text-xs text-purple-400 hover:text-purple-300 flex items-center gap-1.5 transition-colors"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="3" width="7" height="7"></rect><rect x="14" y="3" width="7" height="7"></rect><rect x="14" y="14" width="7" height="7"></rect><rect x="3" y="14" width="7" height="7"></rect></svg><span>Edit & Arrange</span></a>'], _tmpl$18 = ["<div", ' class="text-center py-16 text-[#5b5b6e] text-sm italic">No actions available right now.</div>'], _tmpl$19 = ["<div", ' class="max-w-7xl mx-auto px-4"><div class="relative pt-12 pb-8 text-center mb-10"><div class="absolute top-0 left-0 w-full h-[2px] bg-gradient-to-r from-transparent via-purple-500 to-transparent opacity-50"></div><div class="flex items-center justify-between mb-4"><a href="/library" class="text-xs text-[#8b8b9e] hover:text-white flex items-center gap-1.5 transition-colors"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="15 18 9 12 15 6"></polyline></svg><span>Dashboard Library</span></a><!--$-->', '<!--/--></div><h1 class="text-4xl font-extrabold tracking-tight text-white mb-2">', '</h1><p class="text-[12px] font-bold tracking-widest text-[#5b5b6e] uppercase">Public View • Fixed Layout</p></div><!--$-->', "<!--/--><!--$-->", '<!--/--><div class="mt-12 text-center text-[10px] text-[#5b5b6e]">Powered by <span class="font-bold font-mono text-purple-400/80">solid.grpcfront</span></div></div>'], _tmpl$20 = ["<main", ' class="min-h-screen bg-[#050508] p-6 lg:p-16 font-sans"><!--$-->', "<!--/--><!--$-->", "<!--/--><!--$-->", "<!--/--></main>"], _tmpl$21 = ["<svg", ' width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><polygon points="5 3 19 12 5 21 5 3"></polygon></svg>'], _tmpl$22 = ["<span", ">Execute <!--$-->", "<!--/--></span>"], _tmpl$23 = ["<svg", ' class="animate-spin h-4 w-4 text-purple-400" viewBox="0 0 24 24" fill="none"><circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle><path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path></svg>'], _tmpl$24 = ["<span", ">Running...</span>"], _tmpl$25 = ["<svg", ' class="animate-bounce h-4 w-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3"><polyline points="20 6 9 17 4 12"></polyline></svg>'], _tmpl$26 = ["<span", ">Success!</span>"], _tmpl$27 = ["<svg", ' class="animate-pulse h-4 w-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3"><circle cx="12" cy="12" r="10"></circle><line x1="15" y1="9" x2="9" y2="15"></line><line x1="9" y1="9" x2="15" y2="15"></line></svg>'], _tmpl$28 = ["<span", ">Failed</span>"], _tmpl$29 = ["<div", ' class="rounded-2xl border border-[#2a2a3a] bg-[#0e0e15] p-5 shadow-xl space-y-4 text-left"><div class="flex items-center gap-2 pb-2 border-b border-[#2a2a3a]"><span class="w-2.5 h-2.5 rounded-full bg-purple-500"></span><h3 class="text-sm font-bold text-white">', '</h3></div><div class="grid grid-cols-1 gap-3.5 sm:grid-cols-2">', '</div><div class="pt-2"><button', "><!--$-->", "<!--/--><!--$-->", "<!--/--><!--$-->", "<!--/--><!--$-->", "<!--/--></button></div></div>"], _tmpl$30 = ["<svg", ' width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><polygon points="5 3 19 12 5 21 5 3"></polygon></svg>'], _tmpl$31 = ["<span", ">", "</span>"], _tmpl$32 = ["<svg", ' class="animate-spin h-5 w-5 text-purple-400" viewBox="0 0 24 24" fill="none"><circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle><path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path></svg>'], _tmpl$33 = ["<span", ">Executing...</span>"], _tmpl$34 = ["<svg", ' class="animate-bounce h-5 w-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3"><polyline points="20 6 9 17 4 12"></polyline></svg>'], _tmpl$35 = ["<svg", ' class="animate-pulse h-5 w-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3"><circle cx="12" cy="12" r="10"></circle><line x1="15" y1="9" x2="9" y2="15"></line><line x1="9" y1="9" x2="15" y2="15"></line></svg>'], _tmpl$36 = ["<button", "", "><!--$-->", "<!--/--><!--$-->", "<!--/--><!--$-->", "<!--/--><!--$-->", "<!--/--></button>"], _tmpl$37 = ["<label", ' class="flex items-center gap-3 cursor-pointer py-1.5"><input type="checkbox" class="w-4 h-4 rounded border-[#2a2a3a] bg-[#1e1e2e] text-purple-500 focus:ring-purple-500/50"', '><span class="text-sm text-white">Enable</span></label>'], _tmpl$38 = ["<select", ' class="w-full rounded-lg border border-[#2a2a3a] bg-[#1e1e2e] p-2.5 text-sm text-white focus:border-purple-500 focus:outline-none focus:ring-1 focus:ring-purple-500/50 transition-all"', "><option value disabled>Select an option...</option><!--$-->", "<!--/--></select>"], _tmpl$39 = ["<textarea", ' rows="3"', ' class="w-full rounded-lg border border-[#2a2a3a] bg-[#1e1e2e] p-2.5 text-sm text-white focus:border-purple-500 focus:outline-none focus:ring-1 focus:ring-purple-500/50 transition-all font-mono"', ' placeholder="', '"></textarea>'], _tmpl$40 = ["<input", "", ' class="w-full rounded-lg border border-[#2a2a3a] bg-[#1e1e2e] p-2.5 text-sm text-white focus:border-purple-500 focus:outline-none focus:ring-1 focus:ring-purple-500/50 transition-all"', ' placeholder="', '">'], _tmpl$41 = ["<div", ' class="col-span-1"><label class="block text-xs font-bold text-[#8b8b9e] mb-1.5">', "</label><!--$-->", "<!--/--><!--$-->", "<!--/--><!--$-->", "<!--/--><!--$-->", "<!--/--></div>"], _tmpl$42 = ["<option", ">", "</option>"], _tmpl$43 = ["<div", ' class="', '">', "</div>"], _tmpl$44 = ["<div", ' class="text-[#5b5b6e] text-sm italic">Loading workflow info...</div>'], _tmpl$45 = ["<div", ' class="w-full rounded-xl border border-[#2a2a3a] bg-[#0d0f17] overflow-hidden" style="', '"><div style="width:100%;min-height:inherit"></div></div>'];
...
function PublicDashboard() {
  ...
  return ssr(_tmpl$20, ssrHydrationKey(), escape(createComponent(Show, {
    get when() {
    ...
    get children() {
      return ssr(_tmpl$19, ssrHydrationKey(), escape(createComponent(Show, {
        ...
        get children() {
          return ssr(_tmpl$17, ssrHydrationKey(), `/dashboards/${escape((dashboard()?.id || params.id || "").replace("dashboard:", ""), true)}`);
        }
      })), escape(dashboard().name), escape(createComponent(Show, {
        get when() {
              ...
              return createComponent(Show, {
                ...
                get fallback() {
                  ...
                  return createComponent(Show, {
                    ...
                    get fallback() {
                      return ssr(_tmpl$36, ssrHydrationKey(), ssrAttribute("disabled", state() !== "idle", true) + ssrAttribute("class", escape(btnClass(), true), false), escape(createComponent(Show, {
                        get when() {
                          return state() === "idle";
                        },
                        get children() {
                          return [ssr(_tmpl$30, ssrHydrationKey()), ssr(_tmpl$31, ssrHydrationKey(), escape(btn.label))];
                        }
                      })), escape(createComponent(Show, {
                        get when() {
                        ...
                        get children() {
                          return [ssr(_tmpl$32, ssrHydrationKey()), ssr(_tmpl$33, ssrHydrationKey())];
                        }
                      })), escape(createComponent(Show, {
                        get when() {
                        ...
                        get children() {
                          return [ssr(_tmpl$34, ssrHydrationKey()), ssr(_tmpl$26, ssrHydrationKey())];
                        }
                      })), escape(createComponent(Show, {
                        get when() {
                          return state() === "error";
                        ...
                        get children() {
                          return [ssr(_tmpl$35, ssrHydrationKey()), ssr(_tmpl$28, ssrHydrationKey())];
                        }
                      })));
                    },
                    get children() {
                      return ssr(_tmpl$29, ssrHydrationKey(), escape(btn.label), escape(createComponent(For, {
                        get each() {
                        ...
                        children: (field) => {
                          ...
                          return ssr(_tmpl$41, ssrHydrationKey(), escape(field.label), escape(createComponent(Show, {
                            get when() {
                              return field.type === "boolean";
                            },
                            get children() {
                              return ssr(_tmpl$37, ssrHydrationKey(), ssrAttribute("checked", !!val(), true));
                            }
                          })), escape(createComponent(Show, {
                            get when() {
                            ...
                            get children() {
                              return ssr(_tmpl$38, ssrHydrationKey(), ssrAttribute("value", escape(val(), true) || "", false), escape(createComponent(For, {
                                get each() {
                                  return (field.options || "").split(",").map((o) => o.trim()).filter(Boolean);
                                },
                                children: (opt) => ssr(_tmpl$42, ssrHydrationKey() + ssrAttribute("value", escape(opt, true), false), escape(opt))
                              })));
                            }
                          })), escape(createComponent(Show, {
                            get when() {
                            ...
                            get children() {
                              return ssr(_tmpl$39, ssrHydrationKey(), ssrAttribute("required", field.required, true), ssrAttribute("value", escape(val(), true) || "", false), `Enter ${escape(field.label, true)}...`);
                            }
                          })), escape(createComponent(Show, {
                            get when() {
                            ...
                            get children() {
                              return ssr(_tmpl$40, ssrHydrationKey() + ssrAttribute("type", field.type === "number" ? "number" : "text", false), ssrAttribute("required", field.required, true), ssrAttribute("value", escape(val(), true) || "", false), `Enter ${escape(field.label, true)}...`);
                            }
                          })));
                        }
                        ...
                        get children() {
                          return [ssr(_tmpl$21, ssrHydrationKey()), ssr(_tmpl$22, ssrHydrationKey(), escape(btn.label))];
                        }
                      })), escape(createComponent(Show, {
                        get when() {
                          return state() === "running";
                        ...
                        get children() {
                          return [ssr(_tmpl$25, ssrHydrationKey()), ssr(_tmpl$26, ssrHydrationKey())];
                        }
                      })), escape(createComponent(Show, {
                        get when() {
                          return state() === "error";
                ...
                get children() {
                  return createComponent(Show, {
                    ...
                    get fallback() {
                      return ssr(_tmpl$43, ssrHydrationKey(), `rounded-2xl border p-5 shadow-xl ${kind() === "table" ? "border-emerald-500/20 bg-[#0a120d]" : "border-purple-500/20 bg-[#100a14]"}`, escape(createComponent(Show, {
                        get when() {
                          return wf();
                        },
                        get fallback() {
...
function InfographicWidget(props) {
  ...
  return ssr(_tmpl$45, ssrHydrationKey(), ssrStyle(`min-height:${props.height || "300px"}`));
}
export {
  PublicDashboard as default,
  id$$
};
//# sourceMappingURL=_id_-KbMhWAxG.js.map
